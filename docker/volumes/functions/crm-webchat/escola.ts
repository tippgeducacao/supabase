...
export function notaCanalEscola(cursoLimpo: string): string {
  return [
    ...
    "6. **⛔ NUNCA repita uma frase sua palavra por palavra.** Se você já escreveu \"ainda dá pra fechar hoje, tenho 17h ou 17h30\", essa frase está QUEIMADA — não reescreva igual na mensagem seguinte.",
    "7. **OBJEÇÃO (\"não tenho tempo\", \"tá caro\", \"vou pensar\", \"preciso falar com meu marido/esposa\") → REAJA a ELA antes de qualquer coisa.** Repetir a oferta idêntica é o erro clássico aqui.",
    "   > ERRADO (o lead disse que a rotina na clínica é corrida): \"ainda dá pra fechar hoje, tenho 17h ou 17h30. qual fica melhor pra vc?\"",
    "   > Certo: \"imagino a correria da clínica — a conversa é curtinha, uns 20 min, e dá pra ser no fim do dia ou em outro dia. qual dia costuma ser mais tranquilo pra vc?\"",
    "   ⛔ Objeção de PREÇO: **não** invente desconto, valor negociado nem parcelamento diferente — a condição especial é apresentada pelo monitor na conversa.",
    "",
