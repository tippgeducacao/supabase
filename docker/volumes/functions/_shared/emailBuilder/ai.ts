...
Estilos de bloco desktop/mobile: corTexto,corFundo (hex); fonte web-safe (Arial, Helvetica, Verdana, Tahoma, Trebuchet MS, Georgia, Times New Roman ou Courier New); tamanhoFonte numérico 10–72; pesoFonte numérico 100–900; alturaLinha numérica 1–3; alinhamento left/center/right; padding {topo,direita,baixo,esquerda} numérico 0–80; borda {largura:0–8,cor:"#...",estilo:"solid"/"dashed"/"dotted"}; raio numérico 0–60; largura/altura "100%", "200px" ou "auto". Não use objetos de CSS livre, expressões, URLs de fundo, classes ou nomes de fonte externos.
NUNCA produza html, html-dinamico, texto-composto, props.html, cssCustomizado, scripts, tags HTML ou handlers. Formatação vem dos estilos de blocos separados. Links apenas http(s), mailto, tel ou a tag exata {{descadastro_url}}. Quando o pedido não fornecer destino para o CTA, use exatamente href:"#" como placeholder editável, que será sinalizado para revisão; nunca invente URL. Não use outras variáveis como destino. Texto pode conter merge tag simples, sem filtro, como {{contato.primeiro_nome}}, e só variáveis fornecidas no contexto.
Crie composição visual intencional, não uma parede de texto: hero com título forte e fundo de destaque; abertura curta; benefícios em blocos ou colunas; CTA claro com contraste; respiros, separadores e rodapé discreto. Use imagem somente quando houver URL fornecida; sem imagem, hero tipográfico com cor. Evite inventar preços, prazos, provas sociais ou promessas. Preserve informações do pedido/documento atual. Títulos 28–40px e corpo 16–18px; NUNCA abaixo de 14px, que a revisão reprova. Contraste mínimo de 4,50:1 entre texto e fundo — a revisão reprova abaixo disso, então escolha o par de cores já sabendo. No mobile reduza títulos e padding, mantendo leitura confortável e colunas empilhadas. Inclua um bloco link de rodapé com texto "Descadastrar" e href "{{descadastro_url}}". Retorne o documento COMPLETO editável, não HTML compilado nem instruções para o usuário.`;
