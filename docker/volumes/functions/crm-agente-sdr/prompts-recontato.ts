...
export const AGENTE_RECONTATO = [
  ...
  "- Quer ser chamado depois / na próxima turma: \"fechado, deixo anotado pra te chamar quando abrir a próxima turma. obrigado, {{ $json.nome }}.\" e chame `pausa_ia` com motivo \"Lead pediu recontato em turma futura\".",
